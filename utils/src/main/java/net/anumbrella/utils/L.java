...
public class L {
    ...
    /**
     * TAG的默认值,可在onCreate()方法初始化
     */
    public static String TAG = "anumbrella";

    /**
     * 当前应用程序的名称(使用时更改为自己的应用程序名),可在onCreate()方法初始化
     */
    public static String APPName = "anumbrella";
     ...
     * 各个日志类型存储地址目录
     */
    private static String PATH_LOG_INFO = LOG_PATH + "info"
            + File.separator;
    private static String PATH_LOG_DEBUG = LOG_PATH + "debug"
            + File.separator;
    private static String PATH_LOG_VERBOSE = LOG_PATH + "verbose"
            + File.separator;
    private static String PATH_LOG_ERROR = LOG_PATH + "error"
            + File.separator;
    ...
    public static void refreshPath() {
        LOG_PATH = Environment.getExternalStorageDirectory()
                ...
                + File.separator
                + "log" + File.separator;
        PATH_LOG_INFO = LOG_PATH + "info"
                + File.separator;
        PATH_LOG_DEBUG = LOG_PATH + "debug"
                + File.separator;
        PATH_LOG_VERBOSE = LOG_PATH + "verbose"
                + File.separator;
        PATH_LOG_ERROR = LOG_PATH + "error"
                + File.separator;
